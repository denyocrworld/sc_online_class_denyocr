...
class Chapter0 {
  ...
  bool? exercise100() {
    ...
    String? output;
    output =
        "${input.year}-${_twoDigits(input.month)}-${_twoDigits(input.day)}";
    // --- End of Answer ---
  ...
  bool? exercise152() {
    ...
    List<int>? output;
    output = input.split(',').map((String value) => int.parse(value)).toList();
    // --- End of Answer ---
    return output is List<int> &&
        output.length == 4 &&
        output.contains(42) &&
  ...
  bool? exercise153() {
    ...
    List<bool>? output;
    output = input.split(',').map((String value) => value == 'true').toList();
    // --- End of Answer ---
    return output is List<bool> &&
        output.length == 4 &&
  ...
  bool? exercise154() {
    ...
    List<double>? output;
    output =
        input.split(',').map((String value) => double.parse(value)).toList();
    // --- End of Answer ---
    return output is List<double> &&
        output.length == 3 &&
  ...
  bool? exercise155() {
    ...
    output =
        input.split(',').map((String value) => DateTime.parse(value)).toList();
    // --- End of Answer ---
  ...
  bool? exercise163() {
    ...
    List<String>? output;
    output = input.map((int value) => value.toString()).toList();
    // --- End of Answer ---
  ...
  bool? exercise166() {
    ...
    List<int>? output;
    output = input.expand((element) => element.values).toList();
    // --- End of Answer ---
  ...
  bool? exercise168() {
    ...
    List<int> input = [1, 2, 3, 4, 5];
    Map<String, int>? output;
    output = Map.fromIterable(input,
        key: (kunci) => 'number', value: (nilai) => nilai);
    // --- End of Answer ---
  ...
  bool? exercise169() {
    ...
    output = Map.fromEntries(input.map((String e) => MapEntry(e, e)));
    // --- End of Answer ---
  ...
  bool? exercise174() {
    ...
    output = inputList.map((e) => int.parse(e)).toList();
    // --- End of Answer ---
  ...
  bool? exercise175() {
    ...
    List<double>? output;
    List<String> inputList = input.split(',');
    output = inputList.map((e) => double.parse(e)).toList();
    // --- End of Answer ---
  ...
  bool? exercise176() {
    ...
    List<bool>? output;
    List<String> inputList = input.split(',');
    output = inputList.map((element) => element == 'true').toList();
    // --- End of Answer ---
  ...
  bool? exercise177() {
    ...
    List<DateTime>? output;
    List<String> inputList = input.split(',');
    output = inputList.map((element) => DateTime.parse(element)).toList();
    // --- End of Answer ---
  ...
  bool? exercise178() {
    ...
    String input = 'apple,banana,cherry';
    Map<String, int>? output;
    output = Map.fromIterable(input.split(','), key: (e) => e, value: (_) => 1);
    // --- End of Answer ---
  ...
  bool? exercise179() {
    ...
    output = Map.fromIterable(input.split(',').map((e) => int.parse(e)),
        key: (kunci) => kunci, value: (_) => 'value');
    // --- End of Answer ---
  ...
  bool? exercise180() {
    ...
    List<int>? output;
    output = input.map((e) => e.values).expand((b) => b).toList();
    // --- End of Answer ---
  ...
  bool? exercise184() {
    ...
    Map<String, int>? output;
    output = Map.fromIterable(input,
        key: (buah) => buah, value: (buah) => buah.length);
    // --- End of Answer ---
  ...
  bool? exercise185() {
    ...
    Map<int, int>? output;
    output = Map.fromIterable(input,
        key: (element) => element, value: (element) => element * element);
    // --- End of Answer ---
  ...
  bool? exercise187() {
    ...
    List<String>? output;
    output = input.map((element) => element['fruit'] as String).toList();
    // --- End of Answer ---
  ...
  bool? exercise193() {
    ...
    List<bool>? output;
    List<String> inputList = input.split(',');
    output = inputList.map((e) => e == 'true').toList();
    // --- End of Answer ---
  ...
  bool? exercise195() {
    ...
    List<DateTime>? output;
    List<String> inputList = input.split(',');
    output = inputList.map((e) => DateTime.parse(e)).toList();
    // --- End of Answer ---
  ...
  bool? exercise216() {
    ...
    Map<String, int>? output;
    List<String> inputList = input.split(',');
    output = Map.fromIterable(inputList,
        key: (kunci) => kunci, value: (nilai) => nilai.length);
    // --- End of Answer ---
  ...
  bool? exercise219() {
    ...
    for (String pair in inputList) {
      List<String> parts = pair.split(':');
      String fruit = parts[0];
      bool isFruit = parts[1] == 'true';
      output[fruit] = isFruit;
    }
    // --- End of Answer ---
  ...
  bool? exercise220() {
    ...
    for (String pair in inputList) {
      List<String> parts = pair.split(':');
      String fruit = parts[0];
      DateTime tanggal = DateTime.parse(parts[1]);
      output[fruit] = tanggal;
    }
    // --- End of Answer ---
