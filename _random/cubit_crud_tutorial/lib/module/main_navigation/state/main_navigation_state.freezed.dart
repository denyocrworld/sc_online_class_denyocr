...
class _$MainNavigationStateImpl implements _MainNavigationState {
  _$MainNavigationStateImpl({this.counter = 0, this.selectedIndex = 0});
  ...
  @override
  String toString() {
    return 'MainNavigationState(counter: $counter, selectedIndex: $selectedIndex)';
  }
...
abstract class _MainNavigationState implements MainNavigationState {
  factory _MainNavigationState({int counter, int selectedIndex}) =
