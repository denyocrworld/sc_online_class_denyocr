...
class _$ScheduleImpl implements _Schedule {
  ...
  @override
  String toString() {
    return 'Schedule(id: $id, hospitalId: $hospitalId, doctorId: $doctorId, day: $day, startTime: $startTime, endTime: $endTime, consultationFee: $consultationFee, patientLimit: $patientLimit, createdAt: $createdAt, updatedAt: $updatedAt, hospital: $hospital)';
  }
...
abstract class _Schedule implements Schedule {
  factory _Schedule(
      ...
      @JsonKey(name: 'consultation_fee') final int? consultationFee,
      @JsonKey(name: 'patient_limit') final int? patientLimit,
      @JsonKey(name: 'created_at') final DateTime? createdAt,
      @JsonKey(name: 'updated_at') final DateTime? updatedAt,
      final Hospital? hospital}) = _$ScheduleImpl;
